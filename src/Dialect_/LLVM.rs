...
pub const MlirLLVMLinkagePrivate: std::ffi::c_uint = 0;
pub const MlirLLVMLinkageInternal: std::ffi::c_uint = 1;
pub const MlirLLVMLinkageAvailableExternally: std::ffi::c_uint = 2;
pub const MlirLLVMLinkageLinkonce: std::ffi::c_uint = 3;
pub const MlirLLVMLinkageWeak: std::ffi::c_uint = 4;
pub const MlirLLVMLinkageCommon: std::ffi::c_uint = 5;
pub const MlirLLVMLinkageAppending: std::ffi::c_uint = 6;
pub const MlirLLVMLinkageExternWeak: std::ffi::c_uint = 7;
pub const MlirLLVMLinkageLinkonceODR: std::ffi::c_uint = 8;
pub const MlirLLVMLinkageWeakODR: std::ffi::c_uint = 9;
pub const MlirLLVMLinkageExternal: std::ffi::c_uint = 10;
